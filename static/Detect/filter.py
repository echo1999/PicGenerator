...
def beauty_face2(src):
    ...
    temp4 = cv2.subtract(
        cv2.add(cv2.add(temp3, temp3), src), (10, 10, 10, 255))
...
img = Image.open("./static/image/taylor2.jpg")

#美颜
img1 = cv2.imread("./static/image/taylor2.jpg")
blur4 = beauty_face2(img1)
cv2.imwrite("./static/Detect/filter/美白.jpg", blur4)
